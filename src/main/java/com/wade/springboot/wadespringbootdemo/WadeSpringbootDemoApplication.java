...
public class WadeSpringbootDemoApplication {
    ...
    public static void main(String[] args) {
        SpringApplication springApplication = new SpringApplication(WadeSpringbootDemoApplication.class);
...
//        ApplicationContext applicationContext = SpringApplication.run(WadeSpringbootDemoApplication.class, args);
//
//        Thread subscriber = new Thread(applicationContext.getBean(DataProcessor.class));
